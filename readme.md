...
想象一下，现在很多游戏本质就是一个 CG 播放器，游戏性几乎为 0，但单纯地提取静态 CG 又少了很多 live2D 的要素。此外，一些游戏引擎（例如 unity）并不支持在手机上运行，或者一些 RPG MV maker 的游戏打上 dlc 在手机端会报各种各样的错误。

除了大部分 galgame 带自动播放，很多游戏的 gallery 都不支持自动播放。这使得如果你想要录制剧情，则必须在电脑面前一直点鼠标，而不能去做其他事情。基于这些不便，GalRec 出现了。

**GalRec**是一款 CG 录制工具，用于 Galgame 和有 Gallery 的游戏，可以通过配置一系列任务序列来自动化执行并录制 CG。它支持长时间无人值守运行，并能够处理剧情推动中的**分支情况**。
...
![Alt text](imgs/QQ_1770003661513.png)
...
![Alt text](imgs/78c8e666b2221ba00aa0dccd902848ed.png)
...
![Alt text](imgs/7fadbd4f29caaadc7da3116c9173482c.png)

![Alt text](imgs/e1ac7c702df4df68e0ceecfad5caf0b7.png)

![Alt text](imgs/e2abaef73d62cbc8f65c204875165309.png)
